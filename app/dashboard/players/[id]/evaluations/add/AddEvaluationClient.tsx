...
export default function AddEvaluationClient() {
  ...
  useEffect(() => {
    // Find player from local data instead of fetching from Supabase
    setIsLoading(true);
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      // Create a new evaluation using local data
      const newEvaluation = {
        id: uuidv4(), // Generate a unique ID
        player_id: playerId,
        morale: values.personality, // Map personality to morale for consistency
        ...values,
      };
      ...
      // In a real production app, you would make an API call here
